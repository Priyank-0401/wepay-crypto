  ...
  return (
    <div className="page-container budgets-page">
      ...
      <div className="page-content">
        ...
        {/* Budget Summary (Keep as a card) */}
        <div className="page-card budget-summary-wrapper-card">
        ...
        {/* Budget List (No longer wrapped in a card) */}
        <div className="budgets-content-area">
          {loading ? (
            <div className="page-card"> {/* Keep card for loading/empty state */}
              ...
              {budgets.length === 0 ? (
                ...
                <div className="budgets-list">
                  {budgets.map(budget => {
                    ...
                    return (
                      <div key={budget.id} className="budget-item"> {/* Keep item styling */}
