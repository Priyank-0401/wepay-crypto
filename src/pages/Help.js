...
const Help = () => {
  ...
  // Updated FAQ data with only crypto-relevant questions
  const faqData = [
    {
      id: 1,
        ...
        <div className="help-header-container">
          ...
          <div className="help-search-container">
            <div className="help-search-wrapper">
              <svg className="help-search-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <section className="help-content-section">
        <div className="help-content-container">
          ...
          <nav className="help-navigation">
            ...
            <div className="help-nav-support">
                ...
                <div className="help-section-content">
                  {searchQuery && filteredFaqs.length === 0 ? (
                    <div className="help-empty-state">
                      ...
                      <div className="help-empty-state-title">No Results Found</div>
                      <div className="help-empty-state-text">
                    ...
                    <div className="help-faq-list">
                      {(searchQuery ? filteredFaqs : faqData).map(faq => (
                        <div 
                          key={faq.id} 
                          className={`help-faq-item ${expandedFaqs.includes(faq.id) ? 'expanded' : ''}`}
                        >
                          <div 
            ...
            {(activeCategory !== 'faq' && activeCategory !== 'getting-started') && (
              <div className="help-section">
                ...
                <div className="help-section-content">
                  <div className="help-empty-state">
                    <div className="help-empty-state-icon">🚧</div>
                    <div className="help-empty-state-title">Coming Soon</div>
                    <div className="help-empty-state-text">
